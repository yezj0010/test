...
public class ValidateCode {
	...
	public void createCode() {
        ...
        buffImg = new BufferedImage(width, height, buffImg.TYPE_INT_RGB);
        Graphics2D g = buffImg.createGraphics();
        Random random = new Random();
        // 将图像填充为白色
        g.setColor(Color.WHITE);
//        g.setColor(new Color(27,44,95));//#1a2a60
        g.fillRect(0, 0, width, height);
     // 创建字体,可以修改为其它的 Fixedsys
    ...
    public static void main(String[] args) {
        ValidateCode vCode = new ValidateCode(160,40,5,40);
        try {
            String path="D:/captcha/"+new Date().getTime()+".png";
