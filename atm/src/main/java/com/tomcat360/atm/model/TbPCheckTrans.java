...
public class TbPCheckTrans {
    ...
    private String withExDiff;

    private String withCDiff;
    ...
    public String getWithExDiff() {
        return withExDiff;
    }

    public void setWithExDiff(String withExDiff) {
        this.withExDiff = withExDiff == null ? null : withExDiff.trim();
    }

    public String getWithCDiff() {
        return withCDiff;
    }

    public void setWithCDiff(String withCDiff) {
        this.withCDiff = withCDiff == null ? null : withCDiff.trim();
    }
}