...
public class TbExCheckTrans {
    ...
    public String getWithPDiff() {
        return withPDiff;
    }

    public void setWithPDiff(String withPDiff) {
        this.withPDiff = withPDiff == null ? null : withPDiff.trim();
    }
}